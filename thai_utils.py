...
class ThaiRanker:
    ...
    def group_sentences(self, sentences_with_scores, start_indices_of_paragraphs):
        ...
        while selected_count < max_n:
            ...
            while left_order >= 0 and (sentences_by_order_in_text[left_order][2] <= score or score == 0) \
            ...
            while right_order < max_n and (sentences_by_order_in_text[right_order][2] <= score or score == 0) \
...
class ThaiDisplayer:
    ...
    def show_summary_and_text(info):
        ...
        ThaiDisplayer.display_selected_in_graph(x=list(range(len(sentences_with_scores))),y=y,selected_indices=selected_indices)
